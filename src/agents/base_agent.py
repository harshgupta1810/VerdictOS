...
_AGENT_DIMENSIONS: dict[AgentName, FindingDimension] = {
    AgentName.IP:            FindingDimension.LEGAL,
    AgentName.LITIGATION:    FindingDimension.LEGAL,
    AgentName.REGULATORY:    FindingDimension.LEGAL,
    AgentName.PRIVACY:       FindingDimension.LEGAL,
    AgentName.FINANCE:       FindingDimension.FINANCIAL,
    AgentName.TAX:           FindingDimension.FINANCIAL,
    AgentName.INSURANCE:     FindingDimension.FINANCIAL,
    AgentName.HR:            FindingDimension.PEOPLE,
    AgentName.GOVERNANCE:    FindingDimension.PEOPLE,
    AgentName.RELATED_PARTY: FindingDimension.PEOPLE,
    AgentName.CYBER:         FindingDimension.OPERATIONAL,
    AgentName.ASSETS:        FindingDimension.OPERATIONAL,
    AgentName.SUPPLIER:      FindingDimension.OPERATIONAL,
    AgentName.CUSTOMER:      FindingDimension.OPERATIONAL,
    AgentName.REPUTATION:    FindingDimension.STRATEGIC,
    AgentName.ESG:           FindingDimension.STRATEGIC,
}
            ...
            try:
                ...
                return [
                    Finding(
                        ...
                        dimension=_AGENT_DIMENSIONS.get(self.agent_name, FindingDimension.LEGAL),
